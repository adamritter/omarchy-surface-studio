...
Item {
 ...
 function normalized(v) {
  ...
  for(var panel of [false,true]) {
   ...
   var ranges={lightFollowAmount:[0,1],rimWidth:[0.25,3],edgeProfile:[0,2],roughness:[0.05,1],lightX:[0,1],lightY:[0,1],lightSize:[0.05,1],tintAmount:[0,1],contactStrength:[0,0.7],contactBlur:[1,10],contactOffset:[0,6],controlRadius:[0,20],controlSpacing:[0.7,1.5],controlContrast:[0.3,1.5],textNeutrality:[0,1],outerGap:[0,30],innerPadding:[8,30]}
