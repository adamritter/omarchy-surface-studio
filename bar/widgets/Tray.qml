...
BarWidget {
  ...
  // Keep every tray icon visible; this user bar intentionally has no
  // hover-driven auto-collapse.
  ...
  Component {
    ...
    Item {
      ...
      readonly property int drawerBlockWidth: root.drawerExtent
  ...
  Component {
    ...
    Item {
      ...
      readonly property int drawerBlockHeight: root.drawerExtent
